    ...
    return (
        <div className="container4">
            ...
            <section className="about-container">
                ...
                <p>We are a family-owned company with a passion for quality and a commitment to customer service. We are dedicated to providing the best products and services to our customers.</p>
                <p>Our Group is a leading importer and retailer of furniture. Most of our products are sourced and developed from factories in Vietnam, the United States, Indonesia, Japan, and India.</p>
                <p>We work with quality suppliers and build strong relationships in order to bring you products suited to the South African market</p>
                <strong>Buy with confidence - today's furniture at the best prices direct to you. Click here to <Link to="/shop">visit our shop</Link></strong>
            </section>
            <section className="pledge-container">
                <h3>WE'RE TAKING THE 15% PLEDGE</h3>
                <p>We're ensuring that 15% of our products and collaborations are represented by Black businesses, artists, and designers by 2024.</p>
            </section>
        </div>
    );
}
